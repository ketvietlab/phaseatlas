      ...
      <main class="conversation">
        {#if selectedSession}
          ...
          <footer class="composer-zone">
                ...
                <div class="composer-toolbar">
                  <form class="attachment-entry" onsubmit={(event) => { event.preventDefault(); addAttachment(); }}>
                    ...
                    <ProviderPicker
                      ...
                      disabled={providerPickerLocked}
                      onSelect={(nextRunnerId, nextModelId, nextEffort) => void applyProvider(nextRunnerId, nextModelId, nextEffort)}
                    />
                    {#if chatMode === "edit"}
            ...
            <p class="composer-hint"><span><i></i>{chatMode === "edit" ? editAccessMode === "ask_for_approval" ? "Approval before agent starts · isolated worktree" : "Full repository access · review before apply" : "Read-only repository access"}</span><span>Paste images · Type @ for context · Enter to {chatMode === "edit" ? editAccessMode === "ask_for_approval" ? "review request" : "start edit" : "send"}</span></p>
          </footer>
        {:else}
